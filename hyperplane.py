...
class PhaseDiagramAnalyzer:
    def __init__(self, results_dir):
        ...
        # Save output in 'separation_analysis' folder
    ...
    def calculate_dynamic_thresholds(self):
        ...
        for n in sizes:
            ...
            # Youden's J to find optimal point (Sensitivity + Specificity - 1)
    ...
    def plot_phase_separation(self, thresholds_df):
        ...
        if len(thresholds_df) > 1:
            ...
            # Smooth curve generation using Spline
            if len(x) > 3:
        ...
        # SAVE THE FILE
        output_path = os.path.join(self.output_dir, "viz_hyperplane_separation.png")
